...
function Reco() {
  ...
  return (
    <div>
      <Link
        to="/leads-b2b"
        className="inline-flex items-center gap-1.5 text-sm font-medium text-[#1061AF] hover:underline mb-4"
      >
        ...
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-0.5 text-sm text-[#64748B]">
              Regiões que concentram maior potencial para ação comercial.
            </p>
          </div>
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-4">
          {topOpportunities.map((item) => (
            <div key={item.regiao} className="rounded-lg bg-[#F8FAFC] p-4">
              ...
              <div className="mt-1 text-2xl font-bold text-[#F97316] tabular-nums">
                {item.potenciais}
              </div>
              <div className="text-xs font-semibold text-[#64748B]">potenciais clientes</div>
              <div className="mt-3 text-xs font-medium leading-relaxed text-[#0B1F33]">
                {item.acao}
              </div>
            </div>
          ))}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[380px_1fr] gap-6">
        ...
        <aside className="bg-white rounded-2xl border border-[#DDE5EF] p-6 h-fit">
          <div className="text-[11px] uppercase tracking-wide text-[#64748B] font-semibold">
            Estabelecimento
          </div>
          ...
          <div className="mt-5 space-y-2.5 text-sm">
            {[
              ...
              <div
                key={l}
                className="flex items-center justify-between border-b border-dashed border-[#DDE5EF] pb-2"
              >
          ...
          <div className="mt-5 rounded-xl bg-gradient-to-br from-[#1061AF] to-[#0F58A0] text-white p-5">
            <div className="text-[11px] uppercase tracking-wide text-blue-100 font-semibold">
              Score comercial
            </div>
            ...
            <div className="p-6">
              <div className="flex items-start justify-between gap-4">
                <h2 className="text-2xl font-bold text-[#0B1F33]">
                  Visita presencial com oferta inicial Deusa
                </h2>
                <span className="inline-flex items-center rounded-full px-3 py-1 text-xs font-bold bg-[#ED1C24] text-white shrink-0">
                  Urgência alta
                </span>
              </div>
              <p className="mt-3 text-[#0B1F33] leading-relaxed">
                Priorizar visita presencial com oferta de mix inicial de produtos Deusa, pois o
                estabelecimento está localizado em uma área com baixa cobertura atual, alto
                potencial de demanda e proximidade com outros clientes ativos.
              </p>
              ...
              <div className="mt-6 rounded-xl bg-[#FFF200]/15 ring-1 ring-[#CA8A04]/20 p-5">
                <div className="text-[11px] uppercase tracking-wide font-bold text-[#854D0E]">
                  Próxima melhor ação
                </div>
                <p className="mt-2 text-sm text-[#0B1F33] leading-relaxed">
                  Incluir Empório Família na próxima rota da equipe de Pompéia, junto com outras
                  paradas de alta prioridade na região. Apresentar mix inicial de mercearia e
                  perecíveis.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                <div className="rounded-xl border border-[#DDE5EF] p-4">
                  <div className="text-[11px] uppercase font-semibold text-[#64748B]">
                    Produtos sugeridos
                  </div>
                ...
                <div className="rounded-xl border border-[#DDE5EF] p-4">
                  ...
                  <p className="text-xs text-[#64748B] mt-1">
                    Região com baixa cobertura e alta concentração de oportunidades.
                  </p>
                </div>
              </div>
